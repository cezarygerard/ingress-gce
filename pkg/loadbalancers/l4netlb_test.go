...
func TestEnsureL4NetLoadBalancer(t *testing.T) {
	...
	l4netlb := NewL4NetLbHandler(svc, fakeGCE, meta.Regional, namer, record.NewFakeRecorder(100), &sync.Mutex{})
...
func assertNetLbResources(t *testing.T, apiService *v1.Service, l4NetLb *L4NetLb, nodeNames []string) {
	...
	resourceName, _ := l4NetLb.namer.VMIPNEG(l4NetLb.Service.Namespace, l4NetLb.Service.Name)
